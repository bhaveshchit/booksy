            ...
            <div class="col-md-6 text-center">
                <form class="form-horizontal" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    <fieldset>
                        ...
                        <p class="lead">I’d love to hear from you <?php echo "$username" ?>! Complete the form.</p>
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="number" id="inputEmail" placeholder="NUMBER">
